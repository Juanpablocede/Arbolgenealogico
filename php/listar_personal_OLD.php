        ...
        <table id="ListarData" class="table flex-table table-hover" align="center">
          <thead>
              <tr class="primerafila">
                ...
                <th scope="col" class="col-1 text-center">Sexo</th>
          ...
          <?php
              ...
              while($resultados = pg_fetch_object($resultado))
              {
                echo "<tr>";
                      ...
                      echo "<td><a href='formulario_modificar_personal.php?id_persona=$resultados->id_persona&nombres=$resultados->nombres&apellidos=$resultados->apellidos&sexo=$resultados->sexo&fecha_nacimiento=$resultados->fecha_nacimiento&
                      foto=$resultados->foto&estatus=$resultados->estatus&id_decendencia=$resultados->id_decendencia&nombre_decendencia=$resultados->nombre_descendencia&id_parentesco=$resultados->id_parentesco&
                      descripcion=$resultados->descripcion&posee_decendencia=$resultados->posee_decendencia' name='update' id='update' class='glyphicon glyphicon-pencil btn btn-primary btn-xs update'></a></td>";
                  echo "</tr>";
              }
          ?>
        </tbody>
