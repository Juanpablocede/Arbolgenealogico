...
<body>
  <?php
      ...
      $foto=$_GET['foto'];
      /*$id_persona_antes=$_GET['id_persona'];
      $nombres_antes=$_GET['nombres'];
      $apellidos_antes=$_GET['apellidos'];
      $foto_antes=$_GET['foto'];*/
  ?>
          ...
          <?php
              ...
              while($resultados = pg_fetch_object($resultado))
              {
                echo "<tr>";
                      ...
                      /*echo "<td><a href='detalle_decendencia_personal_01.php?id_persona=$resultados->id_persona&nombres=$resultados->nombres&apellidos=$resultados->apellidos&foto=$resultados->foto&
                      &id_persona_antes=$id_persona&nombres_antes=$nombres&apellidos_antes=$apellidos&foto_antes=$foto'><img class='foto_tabla' src='../imagenes/<?php echo $resultados->foto ?>'>"."</a></td>";
                      echo "<td>".$resultados->descripcion."</td>";
                      echo "<td><a href='detalle_decendencia_personal_02.php?id_persona=$resultados->id_persona' name='consulta' id='consulta' class='glyphicon glyphicon-pencil btn btn-primary btn-xs update'></a></td>";
                      */
                  echo "</tr>";
              }
          ?>
